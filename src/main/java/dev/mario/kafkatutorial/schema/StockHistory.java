 ...
 */
package dev.mario.kafkatutorial.schema;
...
public class StockHistory extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5575065289091730915L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"StockHistory\",\"namespace\":\"dev.mario.kafkatutorial.schema\",\"fields\":[{\"name\":\"tradeId\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"tradeQuantity\",\"type\":\"int\",\"default\":0},{\"name\":\"tradeMarket\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"stockName\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"tradeType\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"price\",\"type\":\"float\",\"default\":0.0},{\"name\":\"amount\",\"type\":\"float\",\"default\":0.0}]}");
   ...
   */
  public static BinaryMessageEncoder<StockHistory> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a StockHistory instance decoded from the given buffer
   ...
   */
  public StockHistory(java.lang.CharSequence tradeId, java.lang.Integer tradeQuantity, java.lang.CharSequence tradeMarket, java.lang.CharSequence stockName, java.lang.CharSequence tradeType, java.lang.Float price, java.lang.Float amount) {
   ...
   * @param value the value to set.
   */
  public void setTradeQuantity(int value) {
   ...
   */
  public static dev.mario.kafkatutorial.schema.StockHistory.Builder newBuilder() {
    return new dev.mario.kafkatutorial.schema.StockHistory.Builder();
  }
   ...
   * @return A new StockHistory RecordBuilder
   */
  public static dev.mario.kafkatutorial.schema.StockHistory.Builder newBuilder(dev.mario.kafkatutorial.schema.StockHistory.Builder other) {
    if (other == null) {
      return new dev.mario.kafkatutorial.schema.StockHistory.Builder();
    } else {
      return new dev.mario.kafkatutorial.schema.StockHistory.Builder(other);
    }
  }
   ...
   * @return A new StockHistory RecordBuilder
   */
  public static dev.mario.kafkatutorial.schema.StockHistory.Builder newBuilder(dev.mario.kafkatutorial.schema.StockHistory other) {
    if (other == null) {
      return new dev.mario.kafkatutorial.schema.StockHistory.Builder();
    } else {
      return new dev.mario.kafkatutorial.schema.StockHistory.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StockHistory>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(dev.mario.kafkatutorial.schema.StockHistory.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(dev.mario.kafkatutorial.schema.StockHistory other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.tradeId)) {
        this.tradeId = data().deepCopy(fields()[0].schema(), other.tradeId);
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder setTradeId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder clearTradeId() {
      tradeId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder setTradeQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder clearTradeQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder setTradeMarket(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder clearTradeMarket() {
      tradeMarket = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder setStockName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder clearStockName() {
      stockName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder setTradeType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder clearTradeType() {
      tradeType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder clearPrice() {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder setAmount(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public dev.mario.kafkatutorial.schema.StockHistory.Builder clearAmount() {
    ...
    throws java.io.IOException
  {
    ...
    out.writeInt(this.tradeQuantity);

    if (this.tradeMarket == null) {
      out.writeIndex(0);
      out.writeNull();
    } else {
      out.writeIndex(1);
      out.writeString(this.tradeMarket);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.tradeQuantity = in.readInt();

      if (in.readIndex() != 1) {
        in.readNull();
        this.tradeMarket = null;
      } else {
        this.tradeMarket = in.readString(this.tradeMarket instanceof Utf8 ? (Utf8)this.tradeMarket : null);
      }
